  ...
  $scope.closeAlert = function(index) {
    ...
    angular.module('app').controller('ButtonsCtrl', function ($scope) {
...
.controller('DrillDownDemoCtrl', function($scope, $element, $timeout, $log) {
    ...
    angular.module('app').controller('TopBarDemoCtrl', function ($scope) {
  ...
  $scope.linkItems = {
    ...
    angular.module('app').controller('OffCanvasDemoCtrl', function ($scope) {

});


    angular.module('app').controller('OrbitDemoCtrl', function ($scope) {

});


    angular.module('app').controller('PaginationDemoCtrl', function ($scope) {
  $scope.totalItems = 64;
  $scope.currentPage = 4;
  $scope.maxSize = 5;
  ...
  $scope.random();
    ...
    angular.module('app').controller('RatingDemoCtrl', function ($scope) {
  $scope.rate = 7;
  $scope.max = 10;
  ...
  $scope.alertMe = function() {
    ...
    angular.module('app').controller('TooltipDemoCtrl', function($scope) {
